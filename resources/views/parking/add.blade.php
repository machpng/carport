        ...
        <div class="row-fluid">
            <div class="box span12">
                ...
                <div class="box-content">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ url('parking/store') }}" method="POST">
                        {{ csrf_field() }}
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="number">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="lng" readonly>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">纬度</label>
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="lat" readonly>
                                </div>
                            </div>
                            <div class="control-group hidden-phone">
                                <label class="control-label" for="textarea2">车库介绍</label>
                                <div class="controls">
                                    <textarea class="cleditor" id="textarea2" rows="3" name="introduction"></textarea>
                                </div>
                            </div>
                            <div class="control-group hidden-phone">
                                <label class="control-label" for="textarea2">摄像头IP地址</label>
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="lat" placeholder="多个请用英文 | 隔开">
                                </div>
                            </div>
                            <div class="control-group hidden-phone">
                                <label class="control-label" for="textarea2">NVR设备地址</label>
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="nvrLat" placeholder="设备地址">
                                </div>
                            </div>
                            <div class="control-group hidden-phone">
                                <label class="control-label" for="textarea2">NVR账号</label>
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="nvrUser" placeholder="NVR账号">
                                </div>
                            </div>
                            <div class="control-group hidden-phone">
                                <label class="control-label" for="textarea2">NVR密码</label>
                                <div class="controls">
                                    <input class="input-xlarge focused" type="text" name="nvrPwd" placeholder="NVR账号">
                                </div>
                            </div>
